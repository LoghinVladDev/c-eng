...
namespace engine :: vulkan :: config {
    ...
    constexpr cds :: uint32 descriptorPoolSizeCount                                 = 256U;

    constexpr cds :: uint32 updateDescriptorCount                                   = 128U;
    constexpr cds :: uint32 updateWriteDescriptorCount                              = updateDescriptorCount;
