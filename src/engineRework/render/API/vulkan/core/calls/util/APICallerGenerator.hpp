...
public:                                                                                                                                                                                                             \
    ...
    inline auto _name ## IndirectIndirection ( F call, R * pResult, ArgumentTypes && ... arguments ) const noexcept -> void {                                                                             \
        * pResult = call ( std :: forward < ArgumentTypes && > ( arguments ) ... );                                                                                                                                 \
    }                                                                                                                                                                                                               \
                                                                                                                                                                                                                    \
    template < typename ... ArgumentTypes, typename F, typename R = cds :: ReturnOf < PFN_ ## _name >, cds :: EnableIf < std :: is_same < R, void > :: value > = 0 >                                                \
    inline auto _name ## IndirectIndirection ( F call, R * , ArgumentTypes && ... arguments ) const noexcept -> void {                                                                                    \
