...
namespace engine { // NOLINT(modernize-concat-nested-namespaces)
    ...
    namespace vulkan {
        ...
        __C_ENG_NO_DISCARD extern auto getPhysicalDeviceQueueFamilyProperties ( __C_ENG_TYPE ( PhysicalDeviceHandle ), cds :: uint32 *, __C_ENG_TYPE ( QueueFamilyProperties ) * = nullptr ) noexcept -> __C_ENG_TYPE ( Result );
        __C_ENG_NO_DISCARD extern auto getPhysicalDeviceQueueFamilyProperties ( __C_ENG_TYPE ( PhysicalDeviceHandle ), cds :: uint32 *, __C_ENG_TYPE ( QueueFamilyExtendedProperties ) * = nullptr ) noexcept -> __C_ENG_TYPE ( Result );
        __C_ENG_NO_DISCARD extern auto getPhysicalDeviceQueueFamilyDetails ( __C_ENG_TYPE ( PhysicalDeviceHandle ), cds :: uint32 *, __C_ENG_TYPE ( QueueFamilyDetails ) * = nullptr ) noexcept -> __C_ENG_TYPE ( Result );
