...
auto C_ENG_CLASS ( MousePressEvent ) :: toString () const noexcept -> String {
...
auto C_ENG_CLASS ( MousePressEvent ) :: equals (
        Object const & object
) const noexcept -> bool {
    ...
    auto pEvent = reinterpret_cast < C_ENG_TYPE ( MousePressEvent ) const * > ( & object );
