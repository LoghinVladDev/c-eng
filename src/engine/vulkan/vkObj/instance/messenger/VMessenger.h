...
namespace engine {
    ...
    public:
         ...
         *
         * @return VulkanResult =
         *      VulkanResult::VK_SUCCESS if Messenger was Initialised OK OR
         *      VulkanResult different from VulkanResult::VK_SUCCESS returned by createDebugMessengerExtension - vulkan function
         */
