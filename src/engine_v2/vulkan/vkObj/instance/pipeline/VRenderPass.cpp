...
extern VulkanFormat getDepthFormat (
...
static inline auto populateAttachmentDescription (
    ...
    * colorAttachment = {
            ...
            .finalLayout    = VulkanImageLayout :: VK_IMAGE_LAYOUT_PRESENT_SRC_KHR
    };
}
...
static inline auto populateRenderPassCreateInfo (
    ...
    * createInfo = { };
    ...
    createInfo->sType               = VulkanStructureType :: VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO;
...
auto engine::VRenderPass::setup(
    ...
    std::array < VulkanAttachmentDescription, 2U > attachmentDescriptions {
