...
namespace engine {
    ...
    public:
        ...
        [[nodiscard]] auto operator == (VSemaphore const & o) const noexcept -> bool {
    ...
    public:
        ...
        [[nodiscard]] auto operator == (VSemaphoreCollection const & o) const noexcept -> bool {
            if ( this == & o ) return true;

            return this->_semaphores == o._semaphores;
        }
